...
请运用空间哲学十大思想家谱系（巴什拉/现象学诗学、海德格尔/筑居思、梅洛-庞蒂/知觉与世界之肉、列斐伏尔/空间生产、福柯/异质拓扑与规训、德·塞托/漫步与日常实践、拉康/拓扑与外亲性、老子/当其无有室之用、大卫·哈维/时空压缩、屈米/事件与转录）进行深度现场解构。
                ...
                readings: {
                  ...
                  items: {
                    ...
                    properties: {
                      thinkerId: {
                        type: Type.STRING,
                        description: 'bachelard, heidegger, merleau-ponty, lefebvre, foucault, certeau, lacan, laozi, harvey, 或 tschumi',
                      },
                      thinkerName: {
                        type: Type.STRING,
